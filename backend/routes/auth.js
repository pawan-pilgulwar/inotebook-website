...
const JWT_SECRET = "Welcome to my server" // used for identification of token
...
router.post('/login',[
    ...
    try {
        ...
        if(!user){
            return res.status(400).json({success, error: "Please try to login to correct credentials."})
        }
