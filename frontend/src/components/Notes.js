  ...
  return (
    <>
      <div className="section-header">
        <h1>Your Notes</h1>
        <p>Organize your thoughts, ideas, and important information in one secure place</p>
      </div>
            ...
            <div className="modal-body">
              <form className='my-3'>
                ...
                <div className="mb-3">
                  ...
                  <textarea className="form-control" id="edescription" value={note.edescription} onChange={onChange} minLength={5} required rows="3"></textarea>
                </div>
                <div className="mb-3">
